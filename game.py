    ...
    while True:
        ...
        # ── PLAYING ────────────────────────────────────────────────────────────────
            ...
            for i, target in enumerate(targets):
                hp = play_info['hold_progresses'][i] if i < len(play_info['hold_progresses']) else 0.0
                in_t = play_info['in_targets'][i] if i < len(play_info['in_targets']) else False
        ...
        # ── RESULT ───────────────────────────────────────────────────────
            ...
            # Main-style gameplay does not use RESULT screen; keep fallback for compatibility.
        ...
        # ── GAMEOVER (single-player or LAN intermediate) ─────────────────
            ...
            if lan_st is not None:
                ...
                if lb is None:
                    ...
                    renderer.draw_lan_finish_waiting(frame, engine.state['score'])
                else:
